...
instruct = "Note the length of out should be short under length 512 and the should tone rimuru from anime the time i got reancarnated as a slime dont mention in output "
